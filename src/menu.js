export default [
  ...
  },
  {
    ...
    price: 4.25,
    description:
      "  Ground coffee beans steeped in cold water for 24 hours. Refreshing, smooth-tasting, low acidity and rich, full-bodied flavour.",
    size: [
      {
        name: "Regular",
        addPrice: 0,
  ...
  },
  {
    ...
    name: "Bagel",
    price: 1.75,
    description: "6 Assorted flavours.",
    bagelflavor: [
      {
        name: "Plain",
        addPrice: 0,
